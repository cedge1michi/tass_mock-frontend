    ...
    <div>
      <div className="grid grid-cols-12 gap-8 mx-4">
        <div className="col-span-6 lg:col-span-2">
          ...
          <select id="content" className="w-full py-2 border-0 border-b border-gray-300 transition focus:ring-0 focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50">
        ...
        <div className="col-span-6 lg:col-span-7">
          ...
          <input type="text" id="company" className="w-full py-2 border-0 border-b border-gray-300 transition focus:ring-0 focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50" placeholder="依頼内容のタイトル" />
        </div>
        <div className="col-span-6 lg:col-span-2">
          ...
          <input type="text" id="company" className="w-full py-2 border-0 border-b border-gray-300 transition focus:ring-0 focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50" placeholder="予算金額（例：10000）" />
          <span className="text-xs text-gray-400">数字を入力してください。</span>
        </div>
        <div className="col-span-6 lg:col-span-2">
          <label htmlFor="process_date" className="block mb-1">期限<span className="ml-2 pb-[2px] px-1 text-xs text-gray-100 rounded-lg bg-orange-500">必須</span></label>
          <input type="datetime-local" id="process_date" className="w-full py-2 border-0 border-b border-gray-300 transition focus:ring-0 focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50" />
        </div>
        ...
        <div className="col-span-full">
          ...
          <textarea id="memo" className="w-full py-2 border rounded-lg border-gray-300 transition focus:ring-0 focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50" placeholder="依頼内容の詳細" rows={3} />
        </div>
      </div>
