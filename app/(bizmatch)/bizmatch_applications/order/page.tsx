  ...
  return (
    <div>
      <div className="grid grid-cols-12 gap-2">
        ...
        <div className="col-span-6 lg:col-span-2 lg:row-start-6">
        ...
        <div className="col-span-6 lg:col-span-2 lg:row-start-9">
      ...
      <div className="mt-2 inline-flex gap-x-2">
        <Button color="blue" onClick={onClickApply}>発注</Button>
